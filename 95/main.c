#include <stdio.h>
 int main() {
       ...
       fp1 = fopen("/home/avinash/number.txt", "w");
      ...
      fprintf(fp1, "\n");
       ...
       fp1 = fopen("/home/avinash/number.txt", "r");
       fp2 = fopen("/home/avinash/even.txt", "w");
       fp3 = fopen("/home/avinash/odd.txt", "w");
       fp4 = fopen("/home/avinash/prime.txt", "w");
